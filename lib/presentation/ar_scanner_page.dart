        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Description
              const Text(
                'We\'re working hard to bring you an amazing AR experience to scan and identify Malaysian landmarks in real-time!',
                style: TextStyle(
                  color: Color(0xFFB3B3B3),
                  fontSize: 16,
                  height: 1.6,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildFeatureItem('📸 Real-time landmark recognition'),
                    _buildFeatureItem('🗺️ Interactive AR overlays'),
                    _buildFeatureItem('📚 Instant landmark information'),
                    _buildFeatureItem('🤖 AI-powered insights'),
                  ],
                ),
              ),
