  ...
  factory ChatSession.fromJson(Map<String, dynamic> json) {
    return ChatSession(
      ...
      messages: (json['messages'] as List).map((m) => ChatMessage(
        ...
        type: MessageType.values.firstWhere((e) => e.toString() == m['type']),
...
class AISettings {
  int humorLevel; // 1-4: Very Serious, Neutral, Light Humor, Very Playful
  String answerLength; // short, medium, detailed
  String professionalism; // casual, friendly, professional
  String avatarOutfit; // traditional, modern, guide, futuristic
  String regionalFocus; // All Malaysia, KL, Penang, etc.
  List<String> specialInterests; // food, culture, shopping, etc.
